...
HRESULT CVIBuffer_Rect::Initialize_Copytype(void* pArg)
{
...
CVIBuffer_Rect* CVIBuffer_Rect::Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
{
