...
public:
    ...
    void    Go_Astar(CNavigation* pNavigation, _int GoalIdx, _float fTimeDelta);
    ...
    void    LookAtSmooth_Second(_vector vTargetPos, float fTime, float fTimeDelta);
...
//////////////////////////
    ...
    void    AddPosition(_float3 vPos, class CNavigation* pNavigation = nullptr);
...
public:
    ...
    void        Set_RotationPerSec(float _fRotationPerSec) { m_fRotationPerSec = _fRotationPerSec; }
